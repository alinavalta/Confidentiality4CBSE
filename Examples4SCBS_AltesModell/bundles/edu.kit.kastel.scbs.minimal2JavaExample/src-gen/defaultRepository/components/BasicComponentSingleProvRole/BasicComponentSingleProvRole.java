package defaultRepository.components.BasicComponentSingleProvRole;

import defaultRepository.contracts.interfaces.OpInterfacePrimitiveTypes;
		
public class BasicComponentSingleProvRole implements OpInterfacePrimitiveTypes {
	
	public BasicComponentSingleProvRole() {
